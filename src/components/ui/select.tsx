...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-xl border border-border/50 bg-muted/30 backdrop-blur-sm px-4 py-2.5 text-sm",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-popover/90 backdrop-blur-2xl text-popover-foreground shadow-xl",
